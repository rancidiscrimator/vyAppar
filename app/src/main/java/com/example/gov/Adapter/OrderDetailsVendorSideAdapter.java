...
public class OrderDetailsVendorSideAdapter extends RecyclerView.Adapter<OrderDetailsVendorSideAdapter.Serviceviewholder> {
    ...
    public OrderDetailsVendorSideAdapter(Context mct,List<ServiceModalClasses> list) {
        this.mct = mct;
        this.list = list;
    }
